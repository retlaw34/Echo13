...
// note: fairly certain this means alphabetical by name=, so take that into account.
...
/datum/supply_pack/emergency/firefighting
	...
	desc = "Only you can prevent plasma fires. Partner up with two firefighter suits, gas masks, flashlights, large oxygen tanks, extinguishers, and hardhats!"
	cost = 1000
...
/datum/supply_pack/emergency/uplinkrecharge
...
/datum/supply_pack/security/ammo
	name = "Ammo Crate"
	desc = "Contains two 20-round magazines for the WT-550 Auto Rifle, three boxes of buckshot ammo, three boxes of rubber shotgun ammo, two boxes of rubbershot 9mm ammo, and one special .38 speedloader of each type available. Requires extended Security access to open."
	cost = 2500
...
/datum/supply_pack/security/securityclothes
	...
	desc = "Contains appropriate outfits for a private security force. Contains outfits for the Warden, Head of Security, and two Security Officers. Each outfit comes with a rank-appropriate jumpsuit, suit, and beret. Requires extended Security access to open."
	cost = 3000
...
/datum/supply_pack/security/armory/makarovs
	...
	desc = "Contains three concealable soviet-era stechkin pistols, produced by the Gorlex Marauders. Requires Armory access to open."
	cost = 9500
...
/datum/supply_pack/security/armory/m10mm_ammo
	...
	desc = "Contains five eight-round magazines for the stechkin pistol. Requires Armory access to open."
...
/datum/supply_pack/engineering/ripley
	...
	desc = "A do-it-yourself kit for building an ALPU MK-I \"Ripley\", designed for lifting and carrying heavy equipment, and other physically-intensive tasks. Batteries not included."
	cost = 2000
...
/datum/supply_pack/engineering/shuttle_in_a_box
	...
	contains = list(
		...
		/obj/item/shuttle_creator //seriously? who gave them all the things to make a shuttle without the thing to ACTUALLY MAKE THE FUCKING SHUTTLE
	)
...
/datum/supply_pack/engine/field_gen
	...
	desc = "Typically the only thing standing between your engineering crew and a messy death. Powered by emitters. Contains two field generators."
	cost = 1500
...
/datum/supply_pack/materials/titanium50
	...
	crate_name = "bulk titanium sheets crate"
...
/datum/supply_pack/service/janitor/janitank
	...
	desc = "Call forth divine judgement upon dirt and grime with this high capacity janitor backpack. Contains 500 units of filth-cleansing space cleaner. Requires janitor access to open."
	cost = 1000
...
/datum/supply_pack/service/vending/modularpc
...
/datum/supply_pack/service/vending/hydro_refills
...
/datum/supply_pack/service/vending/medical
...
/datum/supply_pack/service/vending/mining_vendor
...
/datum/supply_pack/service/vending/security
...
/datum/supply_pack/costumes_toys/costume
	...
	desc = "Supply the sector's entertainers with the equipment of their trade with these Nanotrasen-approved costumes! Contains a full clown and mime outfit, along with a bike horn and a bottle of nothing."
	cost = 1000
	access = ACCESS_THEATRE
